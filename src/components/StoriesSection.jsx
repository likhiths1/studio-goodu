...
export default function StoriesSection() {
  ...
  const srigangaInstagramUrl =
    "https://www.instagram.com/reel/DSHwtB2jLfo/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==";

  const jovoInstagramUrl =
    "https://www.instagram.com/reel/DU2P46UDPUt/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==";
      ...
      <div className="max-w-[90rem] mx-auto">
        ...
        <AnimatedItem className="text-left">
          <h2 className="text-[3.2rem] sm:text-[3.7rem] md:text-[10rem] font-medium tracking-[-0.08em] text-black leading-none mb-8">
            NAMMA GOODU
            <br />
            <span className="block tracking-[-0.08em] leading-none -mt-[6px] md:-mt-[12px]">
              STORIES
            </span>
          </h2>
        </AnimatedItem>
                  ...
                  >
                    ...
                    <div className="relative w-full h-full">
                      ...
                      >
                        ...
                        {/* Sriganga Instagram Link */}
                        {idx === 1 && (
                          <a
                            href={srigangaInstagramUrl}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="absolute top-5 right-5 z-10 text-white underline underline-offset-4 text-sm md:text-base font-medium hover:opacity-70 transition-opacity"
                          >
                            VIEW
                          </a>
                        )}

                        {/* JÖVÖ INDIA Instagram Link */}
                        {idx === 2 && (
                          <a
                            href={jovoInstagramUrl}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="absolute top-5 right-5 z-10 text-white underline underline-offset-4 text-sm md:text-base font-medium hover:opacity-70 transition-opacity"
                          >
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-5 text-white">
                          ...
                          <div className="text-lg md:text-xl font-normal mb-8 leading-tight">
                            {item.text}
                          </div>
                          ...
                          <div className="flex items-center gap-3 mt-3">
                            ...
                            <div>
                              ...
                              <span className="block text-xs font-light tracking-wider">
                                {item.place}
                              </span>
                            </div>
        ...
        <AnimatedItem
          delay={0.7}
          className="w-full flex justify-center mt-10 md:mt-14"
        >
          <a
            href="/contact"
