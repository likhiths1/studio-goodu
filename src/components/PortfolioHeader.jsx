...
export default function PortfolioHeader({ title = "DESIGN ARCHIVE" }) {
  return (
    <AnimatedSection className="w-full bg-[#FFF6ED] py-4 px-3 sm:px-8 md:px-14">
      <div className="max-w-[90rem] mx-auto bg-[#FFF6ED]">
        <div className="flex flex-row items-start justify-between w-full pt-3 pb-2">
          <AnimatedItem>
            <h2 className="font-inter text-black font-medium text-[3.2rem] md:text-[10rem] leading-none tracking-[-0.08em] text-left">
              {title}
            </h2>
          </AnimatedItem>
        </div>
