  ...
  return (
    <section className="w-full bg-[#FEF6ED] py-12 md:py-20 px-4 md:px-6 font-inter">
      <div className="max-w-[90rem] mx-auto">
        {/* Date */}
        <p className="text-sm md:text-base text-center text-gray-500 tracking-wide mb-6">
          APRIL 23, 2025
        </p>

        {/* Title */}
        <h1 className="text-3xl md:text-5xl font-medium text-center text-black mb-12 tracking-tight">
          THE ROLE OF ART IN LUXURY<br />INTERIOR DESIGN
        </h1>

        {/* Intro Paragraph */}
        <p className="font-poppins font-extralight text-base md:text-lg text-black/80 leading-relaxed mb-8 text-justify">
        ...
        <p className="font-poppins font-extralight text-base md:text-lg text-black/80 leading-relaxed mb-12 text-justify">
        ...
        <div className="text-center mb-12">
          <p className="text-2xl md:text-3xl font-normal text-black italic leading-relaxed">
        ...
        {/* Content Paragraphs */}
        <p className="font-poppins font-extralight text-sm md:text-base text-black/80 leading-relaxed mb-8 text-justify">
          In addition to its visual impact, art in luxury interior design often reflects the homeowner's values, interests, or life experiences. Whether it's evoking nostalgia, honors cultural heritage, or supports a cause, art becomes a form of storytelling that enriches the space and the lives of those who live within it.
        </p>

        <p className="font-poppins font-extralight text-sm md:text-base text-black/80 leading-relaxed mb-16 text-justify">
        ...
        <div className="flex items-center justify-between border-t border-[#969696] pt-6 md:pt-8">
          ...
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="opacity-80">
          ...
          <div className="flex items-center justify-center">
            <img src={GooduLogo} alt="Studio Goodu" className="w-10 h-auto md:w-12 object-contain" />
          </div>
